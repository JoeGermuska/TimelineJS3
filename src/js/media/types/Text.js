...
export class Text {
    ...
    _initLayout() {
        ...
        // Create Layout
        this._el.content_container = DOM.create("div", "tl-text-content-container",
            this._el.container, { tabIndex: 0 });

        // Date
        this._el.date = DOM.create("h3",
            "tl-headline-date",
            this._el.content_container, { tabIndex: 0 });
        ...
        if (this.data.headline != "") {
            ...
            this._el.headline = DOM.create("h2", headline_class,
                this._el.content_container, { tabIndex: 0 });
